  ...
  return (
    <>
        ...
        <Link to='/sales' className=''>
            ...
            <button className='btnWish'>Add to Wishlist<BsFillCartFill size={45} className='icon' /></button>
            <button className='btnAdd'> Add to Cart <BsFillCartFill size={45} className='icon' /></button>
